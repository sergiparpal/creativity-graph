...
tools: Read, Grep, mcp__plugin_sproutgraph_sproutgraph__kg_context, mcp__plugin_sproutgraph_sproutgraph__query_graph, mcp__plugin_sproutgraph_sproutgraph__get_neighbors, mcp__plugin_sproutgraph_sproutgraph__kg_write, mcp__plugin_sproutgraph_sproutgraph__kg_ground
model: opus
---
...
- `mcp__plugin_sproutgraph_sproutgraph__kg_context(query=None, budget=2000)` →
...
- `mcp__plugin_sproutgraph_sproutgraph__query_graph(node_type=None, relation=None, epistemic_state=None, limit=50)` →
...
- `mcp__plugin_sproutgraph_sproutgraph__get_neighbors(node_id, relation=None)` → the incident edges of a hub: these are the
