...
tools: Read, Grep, mcp__creativity-graph__query_graph, mcp__creativity-graph__get_node, mcp__creativity-graph__kg_context, mcp__creativity-graph__kg_ground
---
...
`mcp__creativity-graph__kg_ground` is the **only** way to set an epistemic verdict (§1.4/§1.8). You may not
...
```
mcp__creativity-graph__kg_ground(
...
- The unverified queue, from `mcp__creativity-graph__query_graph(epistemic_state="unverified", limit=50)`
...
- Triage signal, from `mcp__creativity-graph__kg_context(budget=2000)` → `items[]`,
