# Releasing creativity-graph

This is the maintainer checklist for cutting a public release. Everything up to step 4 is automated
and reproducible; **step 4 (public publish + tag) is an outward-facing action a human runs
